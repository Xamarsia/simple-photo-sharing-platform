...
### [Auth Controller](./src/main/java/com/xamarsia/simplephotosharingplatform/controller/AuthController.java)
...
### [User Controller](./src/main/java/com/xamarsia/simplephotosharingplatform/controller/UserController.java)
...
| GET | `/user/isUsernameUsed/{username}` | Check if a username is already in use. | - |
| GET | `/user/isRegistered` | Check if the authenticated user is registered.| + |
| POST | `/user/register` | Register a new user. | + |
| GET | `/user/{username}/profile` |  Retrieve the user profile information by username. | + |
| GET | `/user/{username}/image` |  Retrieve the profile image of a user by username. | - |
| GET | `/user/{username}/followers` |  Retrieve a paginated list of followers for a user by username.| + |
| GET | `/user/{username}/followings` |  Retrieve a paginated list of followings for a user by username. | + |
| GET | `/user/{postId}/liked` | Retrieve a paginated list of users who liked a specific post. | + |
| GET | `/user/search` | Search for users based on a query. Users are selected by username or full name. | + |
| PUT | `/user/follow/{followerUsername}` | Add a follower for the authenticated user. | + |
| PUT | `/user/deleteFollowing/{followerUsername}` | Remove a follower for the authenticated user. | + |
| PUT | `/user/updateUserInfo` | Update the authenticated user's information. | + |
| PUT | `/user/updateUsername` | Update the authenticated user's username. | + |
| PUT | `/user/image` | Upload a new profile image for the authenticated user. | + |
| DELETE | `/user/image` | Delete the profile image of the authenticated user. | + |
| DELETE | `/user/` | Delete the authenticated user account. | + |

### [Post Controller](./src/main/java/com/xamarsia/simplephotosharingplatform/controller/PostController.java)
...
| Method | URI Template | Action | Authorisation Required |
| --- | --- | --- | :-: |
| GET | `/post/{postId}/detailed` |  Retrieves detailed information about a post by its ID. | + |
| GET | `/post/{postId}` |  Retrieves a post by its ID. | - |
| GET | `/post/{postId}/image` | Retrieves the image associated with a post by its ID. | - |
| POST | `/post/create` | Creates a new post. | + |
| PUT | `/post/{postId}/updateImage` | Update the image of an existing post. | + |
| PUT | `/post/{postId}/updatePostInfo` | Update the information of an existing post by its ID. | + |
| GET | `/post/preview/{username}` | Retrieve a paginated preview of posts for specific user by username. | - |
| GET | `/post/newsFeed` | Retrieve a paginated news feed of posts. | + |
| DELETE | `/post/{postId}` | Delete a specific post identified by its ID. | + |

### [Like Controller](./src/main/java/com/xamarsia/simplephotosharingplatform/controller/LikeController.java)
...
| Method | URI Template | Action | Authorisation Required |
| --- | --- | --- | :-: |
| POST | `/like/{postId}` | Like a post by its ID. | + |
| DELETE | `/like/{postId}` | Unlike a post by its ID. | + |
