...
5. Setup the environment variables by creating `.env` and `.aws-credentials` files in the root of the project directory with the following content:
   ...
   Refer to the [Firebase setup](https://github.com/Xamarsia/spsp-deployment/tree/main#firebase-setup) article to understand about the source of the `PUBLIC_FIREBASE_PROJECT_ID` variable.
   ...
   Refer to the [AWS setup](https://github.com/Xamarsia/spsp-deployment/tree/main#aws-setup) article to understand about the source of the `AWS_*` variables.
...
| Method | URI Template | Action | Authorization Required |
| --- | --- | --- | :-: |
...
| Method | URI Template | Action | Authorizations Required |
| --- | --- | --- | :-: |
